...
class MonteCarloGreedyPolicy(policies.BasePolicy):
  ...
  def __init__(self,
               venv: vec_env.VecEnv,
               reward_model: rewards.RewardModel,
               n_samples=100):
...
def load_monte_carlo_greedy(path: str, env: vec_env.VecEnv,
                           ) -> MonteCarloGreedyPolicy:
...
policy_serialize.policy_registry.register(key="evaluating_rewards/MCGreedy-v0",
                                          value=load_monte_carlo_greedy)
